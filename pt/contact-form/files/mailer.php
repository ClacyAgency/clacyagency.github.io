...
$message_success = 'Obrigado, a sua mensagem foi enviada com sucesso.';
$message_unset_fields = "Por favor, preencha os campos obrigatórios assinalados com *.";
...
if ( ! isset($_POST['form_token']) || $_POST['form_token'] !== $_SESSION['security_token']) {
	...
	redirect($return_url, 'Não é possível verificar que está a enviar a mensagem pelo nosso formulário. Por favor, tente mais tarde ou utilize um dos nossos contactos alternativos.');
}
