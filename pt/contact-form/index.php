<?php
	...
	if ( ! isset($_SESSION['formMessage'])) {
		$_SESSION['formMessage'] = '<h2>Mande uma mensagem</h2>
Estamos sempre à procura de projetos novos e emocionantes. Preencha o formulário para nos enviar uma mensagem e espero que possamos trabalhar num projeto juntos!';	
	}
	
	if ( ! isset($_SESSION['formFooter'])) {
		$_SESSION['formFooter'] = '<br /><h5>Iremos entrar em contacto consigo o mais rapidamente possível</h5>
Faremos o nosso melhor para entrar em contacto no prazo máximo de 48 horas depois de receber a sua mensagem.';
	}
...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
			...
			<header role="banner">
				...
				<div id="lang">
					<a href="../../" title="View in English">English</a>
				</div>
				...
				<div id="title_wrapper">
						...
						<h2 id="site_slogan" data-0="opacity: 1; top:0px;" data-600="opacity: 0; top: 80px;" data-anchor-target="#site_slogan">
							A melhorar vidas com uma aplicação de cada vez
						</h2>
				...
				<div id="navigation_bar">
					...
					<div class="row site_width">
						<div class="large-12 columns">
							...
							<ul>
								<li><a href="../index.html#navigation_bar" rel="">Agência</a></li>
								<li><a href="../work/index.html#navigation_bar" rel="">Portfólio</a></li>
								<li><a href="../team/index.html#navigation_bar" rel="">Equipa</a></li>
								<li><a href="./" rel="" id="current">Contacto</a></li>
								<li><!-- Fix --></li>
							</ul>
							</nav>
						</div>
		...
		<nav id="mobile_navigation">
			<ul>
			<li><a href="../index.html#mobile_navigation_toggle" rel="">Agência</a></li>
			<li><a href="../work/index.html#mobile_navigation_toggle" rel="">Portfólio</a></li>
			<li><a href="../team/index.html#mobile_navigation_toggle" rel="">Equipa</a></li>
			<li><a href="./" rel="" id="current">Contacto</a></li>
			</ul>
		</nav>
		...
		<div class="row site_width" id="container">
			...
			<section id="content"class="large-8 columns">
				...
				<form action="./files/mailer.php" method="post" enctype="multipart/form-data">
					 <div>
						...
						<label>Plafond estimado:</label> <br />
						<select name="form[element3]">			<option <?php echo check('element3', 'select','Not sure'); ?> value="Not sure">Não sei</option>
						...
						<input class="form-input-button" type="submit" name="submitButton" value="Submeter" />
					</div>
				</form>
			...
			<aside id="sidebar" class="large-4 columns">
				<!-- Sidebar content -->
				<h4 id="sidebar_title">Mensagem direta</h4>
